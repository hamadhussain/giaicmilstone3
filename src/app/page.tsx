    ...
    <div className="max-w-4xl mx-auto p-8 bg-white h-screen rounded-lg">
      {!isSubmitted ? (
        <form onSubmit={handleSubmit}>
          <h1 className="text-center text-4xl font-bold mb-8">Submit Form To Generate Resume</h1>
          <div>
          ...
          <div className="mt-6">
            <label className="block text-lg font-semibold">Work Experience</label>
            <input
              type="text"
              name="workExperience"
        ...
        <div className="mt-8">
          <h2 className="text-3xl font-semibold text-center mb-8">{formData.name} Resume</h2>
          <div>
            ...
            <section className="mb-8">
              <h3 className="text-2xl font-bold text-gray-700">Work Experience</h3>
